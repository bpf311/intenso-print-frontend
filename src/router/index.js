...
import CrearOrdenDeServicio from "@/views/OrdenDeServicio/Crear.vue";
import EditarOrdenDeServicio from "@/views/OrdenDeServicio/Editar.vue";
import DatosOrdenDeServicio from "@/views/OrdenDeServicio/Datos.vue";
...
import DatosOrdenDeVenta from "@/views/OrdenDeVenta/Datos.vue";
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: CrearOrdenDeServicio,
          },
          {
            name: "Editar orden de servicio",
            path: "editar-orden-de-servicio/:idOrden/:idOrdenDeServicio/:tipoCliente",
            component: EditarOrdenDeServicio,
          },
          {
            name: "Datos de orden de servicio",
            path: "datos-orden-de-servicio/:idOrden/:idOrdenDeServicio/:tipoCliente/:vistaAnterior",
            component: DatosOrdenDeServicio,
          },
        ],
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            path: "datos-orden-de-venta/:idOrden/:idOrdenDeVenta/:tipoCliente/:vistaAnterior",
            component: DatosOrdenDeVenta,
          },
        ],
      },
      {
