<template>
  <v-container>
              ...
              <v-card class="elevation-10">
                ...
                <v-card-text>
                  <v-row>
                    ...
                    <v-col cols="12" md="6">
                      <ValidationProvider name="Cliente" rules="required_if:Tipo de cliente" v-slot="{ errors }">
                        <v-autocomplete
                          ...
                          persistent-hint
                          clearable
                          :error-messages="obtenerValidaciones(errors, 'id_cliente')"
                        />
                      </ValidationProvider>
                    </v-col>
                    <v-col cols="12" md="2">
                    ...
                    <v-col cols="12">
                      <ValidationProvider name="Descripción" rules="required" v-slot="{ errors }">
                        <v-textarea
                          ...
                          color="blue darken-4"
                          :error-messages="obtenerValidaciones(errors, 'descripcion_orden_de_trabajo')"
                        />
                      </ValidationProvider>
                    </v-col>
                  </v-row>
              ...
              <v-card class="elevation-10">
                ...
                <v-card-subtitle class="mt-2">
                  <v-alert
                    ...
                    class="mb-8"
                  >
                    Es obligatorio seleccionar al menos un suministro y asignarle una cantidad válida.
                  </v-alert>
                </v-card-subtitle>
                <div>
              ...
              <v-card class="elevation-10">
                ...
                <v-card-text class="mt-5">
                  <v-row class="d-flex justify-space-around">
                    ...
                    <v-col cols="12" md="4">
                      <ValidationProvider name="Monto cancelado" :rules="'required|double:2|min_value:0|max_value:' + ordenDeVenta.precioTotal" v-slot="{ errors }">
                        <v-text-field
                          ...
                          color="blue darken-4"
                          suffix="Bs"
                          :error-messages="obtenerValidaciones(errors, 'monto_cancelado')"
                        />
                      </ValidationProvider>
                    </v-col>
    ...
    <v-dialog v-model="ventanaRegistroCliente" width="1000" persistent>
      <RegistrarNuevoCliente @cerrar-ventana="ventanaRegistroCliente = false"
...
export default {
  ...
  methods: {
    enviarFormulario () {
      this.$refs.obs.validate().then((valid) => {
        if (!valid) {
          ...
          if (errorField) {
            errorField.scrollIntoView(false, { behavior: 'smooth', block: 'start', inline: 'nearest' })
          }
        } else {
    ...
    establecerSuministros (suministros, total) {
      console.log(suministros, total)
      if (total === '0.00') {
        this.ordenDeVenta.precioTotal = null
      } else {
        this.ordenDeVenta.precioTotal = total
      }
      if (suministros.length > 0 && suministros.every(suministro => suministro.cantidad)) {
    ...
    generarContenidoImprimir () {
      const cuerpo = this.datosImpresion.suministros.map(suministro => [
      ...
      const printContent = [
        {
          ...
          value: 'INTENSO PRINT',
          style: { fontWeight: '700', textAlign: 'center', fontSize: '24px', marginBottom: '10px' }
        },
        {
          type: 'text',
          value: 'Recibo',
        ...
        },
        {
          type: 'text',
          value: '--------------------------------------',
          style: { fontWeight: '200', textAlign: 'center', fontSize: '13px' }
        },
        {
          type: 'text',
          value: 'Fecha: ' + this.datosImpresion.datosRecibo.fecha_formateada,
          style: { fontWeight: '200', textAlign: 'left', fontSize: '15px' }
        },
        {
          type: 'text',
          value: 'Cliente: ' + this.datosImpresion.datosRecibo.datos_cliente,
          style: { fontWeight: '200', textAlign: 'left', fontSize: '15px' }
        },
        {
          type: 'text',
          value: 'CI/NIT: ' + this.datosImpresion.datosRecibo.nit_ci_cliente,
          style: { fontWeight: '200', textAlign: 'left', fontSize: '15px' }
        },
        {
          type: 'text',
          value: 'Código de orden: ' + this.datosImpresion.datosRecibo.codigo_orden_de_venta,
          style: { fontWeight: '200', textAlign: 'left', fontSize: '15px', marginBottom: '10px' }
        },
        {
          type: 'table',
          // style the table
          ...
          tableHeader: ['Desc.', 'Cant.', 'P. Unit.', 'Subtotal'],
          // multi dimensional array depicting the rows and columns of the table body
          tableBody: cuerpo,
          // list of columns to be rendered in the table footer
          tableFooter: [' ', ' ', 'Total: ', this.datosImpresion.datosRecibo.precio_total + ' Bs.'],
        ...
        {
          type: 'text',
          value: 'Importe: ' + this.datosImpresion.datosRecibo.monto_cancelado_actual + ' Bs.',
          style: { fontWeight: '200', textAlign: 'left', fontSize: '15px', marginTop: '10px' }
        },
        {
          type: 'text',
          value: 'Saldo: ' + this.datosImpresion.datosRecibo.saldo_restante + ' Bs.',
          style: { fontWeight: '200', textAlign: 'left', fontSize: '15px' }
        },
        {
          type: 'text',
        ...
        {
          type: 'text',
          value: 'Usuario: ' + this.datosImpresion.datosRecibo.usuario,
          style: { fontWeight: '200', textAlign: 'left', fontSize: '15px' }
        },
        {
          type: 'text',
        ...
        },
        {
          ...
          style: { fontWeight: '200', textAlign: 'center', fontSize: '15px' }
        }
      ]
